/*
* devices.h part of tcosxmlrpc
*   => common headers of devices.c
...
#define DEVICES_OK    "ok: device action done."
#define DEVICES_ERROR "error: device action error."

#define DEVICES_READING_ERROR "error: reading devices settings."
